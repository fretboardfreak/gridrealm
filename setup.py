...
class SetupCommand(Command):
    ...
    def software_package(self):
        """Get the path to the software parkage."""
    ...
    def test_paths(self):
        ...
        return [self.software_package, __file__,
                os.path.join(self.setup_path, 'src/scripts')]
...
setup(
    ...
    author='Curtis Sand, Dennison Gaetz',
    author_email='curtissand@gmail.com, djgaetz@gmail.com',
    license="Proprietary",
    package_dir={'': 'src'},
